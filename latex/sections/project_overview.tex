...
\textbf{ĐỀ TÀI: Xây dựng hệ Neuro-Fuzzy thích nghi (ANFIS) dự báo phụ tải điện năng hộ gia đình dựa trên các yếu tố khí tượng và thói quen sinh hoạt.}

\section{Mục tiêu tổng quát}

Đề tài hướng tới xây dựng một mô hình dự báo phụ tải điện năng theo giờ bằng mô hình ANFIS trong bối cảnh hộ gia đình. Với một thời điểm quan sát $t$, hệ thống dự báo điện năng tiêu thụ tại hai mốc tương lai:
...
\begin{table}[H]
  ...
  \begin{tabular}{p{4cm} p{9cm}}
    ...
    Đặc trưng Core & \texttt{apparent\_temperature}, \texttt{humidity}, \texttt{hour\_sin}, \texttt{hour\_cos}, \texttt{occupancy\_level}, \texttt{load\_lag\_1}, \texttt{load\_lag\_24}. Đây là nhóm đặc trưng chính dùng cho ANFIS. \\
...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item Đánh giá mô hình bằng các độ đo MAE, RMSE, MAPE và hệ số $R^2$.
